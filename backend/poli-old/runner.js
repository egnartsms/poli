...
changeImportsForRename ::=
   function (mid, oldName, newName) {
...
hasModuleRef ::=
   function (mid, ref, exceptEntry=null) {
...
computeForwardModificationsOnMoveEntry ::=
   function (srcmid, entryName, dstmid) {
      let danglingRefs = [];
      let offendingRefs = [];
      let renames = [];
      let importsToAdd = [];
...
computeBackwardModificationsOnMoveEntry ::=
   function (srcmid, entryName, dstmid) {
...
removeEntryFromModule ::=
   function (module, entryName) {
...
moveEntry ::=
   function (srcmid, entryName, dstmid, index) {
      if (srcmid === dstmid) {
